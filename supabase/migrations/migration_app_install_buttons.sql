-- 1. Alter adds and addsactive tables to support iOS/Android download links and click tracking
ALTER TABLE public.adds ADD COLUMN IF NOT EXISTS action_ios TEXT DEFAULT NULL;
ALTER TABLE public.adds ADD COLUMN IF NOT EXISTS action_android TEXT DEFAULT NULL;
ALTER TABLE public.adds ADD COLUMN IF NOT EXISTS clicks_ios INT DEFAULT 0;
ALTER TABLE public.adds ADD COLUMN IF NOT EXISTS clicks_android INT DEFAULT 0;
ALTER TABLE public.adds ADD COLUMN IF NOT EXISTS clicks_read_more INT DEFAULT 0;

ALTER TABLE public.addsactive ADD COLUMN IF NOT EXISTS action_ios TEXT DEFAULT NULL;
ALTER TABLE public.addsactive ADD COLUMN IF NOT EXISTS action_android TEXT DEFAULT NULL;
ALTER TABLE public.addsactive ADD COLUMN IF NOT EXISTS clicks_ios INT DEFAULT 0;
ALTER TABLE public.addsactive ADD COLUMN IF NOT EXISTS clicks_android INT DEFAULT 0;
ALTER TABLE public.addsactive ADD COLUMN IF NOT EXISTS clicks_read_more INT DEFAULT 0;

-- 2. Drop existing submit_ad_campaign RPC function to allow parameter updates
...
-- 3. Recreate submit_ad_campaign RPC supporting iOS/Android links
...
-- 4. Recreate increment_ad_click RPC supporting ios, android and read_more clicks
...
GRANT EXECUTE ON FUNCTION public.submit_ad_campaign(UUID, TEXT, TEXT[], TEXT[], TEXT[], TEXT[], TEXT[], INT[], BOOLEAN, INT, INT, INT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, TEXT, BOOLEAN, NUMERIC, TEXT, TEXT, TEXT, TEXT, TEXT) TO anon;
GRANT EXECUTE ON FUNCTION public.submit_ad_campaign(UUID, TEXT, TEXT[], TEXT[], TEXT[], TEXT[], TEXT[], INT[], BOOLEAN, INT, INT, INT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, TEXT, BOOLEAN, NUMERIC, TEXT, TEXT, TEXT, TEXT, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.submit_ad_campaign(UUID, TEXT, TEXT[], TEXT[], TEXT[], TEXT[], TEXT[], INT[], BOOLEAN, INT, INT, INT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, TEXT, BOOLEAN, NUMERIC, TEXT, TEXT, TEXT, TEXT, TEXT) TO service_role;
